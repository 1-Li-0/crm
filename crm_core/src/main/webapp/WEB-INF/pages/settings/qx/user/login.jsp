			...
			<form action="workbench/index.html" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<div class="checkbox"  style="position: relative;top: 30px; left: 10px;">
						<label>
							<c:if test="${cookie.isRemPwd.value.equals('true')}">
								<input id="isRemPwd" type="checkbox" checked> 记住账号密码
							</c:if>
							<c:if test="${not cookie.isRemPwd.value.equals('true')}">
								<input id="isRemPwd" type="checkbox"> 记住账号密码
							</c:if>
						</label>
						&nbsp;&nbsp;
						<span id="msg"></span>
