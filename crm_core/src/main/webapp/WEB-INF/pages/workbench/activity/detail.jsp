...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#remarkDivList").on("click","a[name=deleteA]",function () {
			...
			$.ajax({
				url: "workbench/activity/deleteActivityRemarkByRemarkId.do",
				...
				success:function (data) {
					if (data.code=="1"){
						...
						//局部div刷新
						$("#remarkDivList").load(location.href + " #remarkDivList>*","");
					}else {
						alert(data.message)
					}
				}
		...
		$("#remarkDivList").on("click","a[name=editA]",function () {
			...
			$("#remarkId").val(id);
			$("#noteContent").val($(this).parent("div").parent("div").children("h5").text());
			...
			$("#updateRemarkBtn").click(function (){
				...
				var id = $("#remarkId").val();
				$.ajax({
					url:"workbench/activity/editRemarkNoteContentById.do",
					data:{
						id:id,
			...
			$.ajax({
				...
				success:function (data) {
					if (data.code=="1"){
						$("#remark").val("");
						var htmlStr="";
						htmlStr += "<div id=\"remark_\"+data.retData.id class=\"remarkDiv\" style=\"height: 60px;\">";
...
<body>
	...
	<div id="remarkDivList" style="position: relative; top: 30px; left: 40px;">
		...
		<div id="remark_${activityRemark.id}" class="remarkDiv" style="height: 60px;">
